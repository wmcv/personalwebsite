...
const addArchitectureXray = () => {
  document.querySelectorAll("[data-architecture]").forEach((link) => {
    if (link.querySelector(".architecture-xray")) return;

    const summary = document.createElement("span");
    summary.className = "architecture-xray";
    summary.textContent = link.dataset.architecture;
    summary.setAttribute("aria-hidden", "true");

    link.classList.add("architecture-link");
